...
class ProfileSetupViewModel(
    ...
    private val saveMyWorkProfileUseCase: SaveMyWorkProfileUseCase,
    ...
    private fun fetchExistingProfile() {
        viewModelScope.launch {
            myProfileRepository.getWorkProfile().collect { result ->
    ...
    fun onSaveWorkProfile() {
        val currentState = _uiState.value
        viewModelScope.launch {
            val result = saveMyWorkProfileUseCase(currentState.toDomain())
